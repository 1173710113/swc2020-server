...
public class RelationBuilder {
  ...
  public RelationBuilder() throws UnknownHostException, IOException {
    connect = new CorrespondUtil(InetAddress.getByName("localhost"), InetAddress.getByName("localhost"), 12344, 8888);
  }

  public RelationBuilder(GraphRelationConfiguration relationConfig)
